...
import com.ThePorscheProject.domain.Role;
...
import com.ThePorscheProject.util.CookieUtils;
...
//		        	.failureUrl("/failure"); // this can be linked to a failure message on the failure template
					.usernameParameter("email").successHandler(new AuthenticationSuccessHandler() {
								...
								public void onAuthenticationSuccess(HttpServletRequest request,
									...
									// HttpServletResponseWrapper ensures that the cookie is set only when the
					...
					logoutConfigurer.logoutUrl("/logout").logoutSuccessUrl("/login")
							// delete cookies from client after logout
							.deleteCookies("accessToken").deleteCookies("refreshToken").deleteCookies("JSESSIONID")
